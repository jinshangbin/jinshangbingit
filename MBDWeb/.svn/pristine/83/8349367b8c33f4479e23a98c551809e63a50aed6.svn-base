...
function(a) {
    ...
    function a(a) {
        return a = +a,
        a !== a ? a = 0 : 0 !== a && a !== 1 / 0 && a !== -(1 / 0) && (a = (a > 0 || -1) * Math.floor(Math.abs(a))),
        a
    }
    function b(a) {
        var b = typeof a;
    ...
    Function.prototype.bind || (Function.prototype.bind = function(a) {
        ...
        return b.prototype && (d.prototype = Object.create(b.prototype)),
        d
    });
    var d, e, f, g, h, i = Function.prototype.call,
    j = Array.prototype,
    k = Object.prototype,
    l = j.slice,
    m = i.bind(k.toString),
    n = i.bind(k.hasOwnProperty);
    ...
    if (Array.prototype.forEach || (Array.prototype.forEach = function(a) {
        var b = E(this),
        c = q && "[object String]" == m(this) ? this.split("") : b,
        d = arguments[1],
        e = -1,
        f = c.length >>> 0;
        ...
        var b, c = E(this),
        d = q && "[object String]" == m(this) ? this.split("") : c,
        e = d.length >>> 0,
        f = [],
        g = arguments[1];
        if ("[object Function]" != m(a)) throw new TypeError(a + " is not a function");
        ...
        var c = q && "[object String]" == m(this) ? this.split("") : E(this),
        d = c.length >>> 0;
        if (!d) return - 1;
        var e = 0;
